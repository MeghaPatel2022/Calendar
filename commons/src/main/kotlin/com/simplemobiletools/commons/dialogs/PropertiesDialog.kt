    ...
    constructor(activity: Activity, path: String, countHiddenItems: Boolean = false) : this() {
        ...
        ensureBackgroundThread {
            ...
            activity.runOnUiThread {
                (view.findViewById<LinearLayout>(R.id.properties_size).property_value as TextView).text =
                    size

                if (fileDirItem.isDirectory) {
                    (view.findViewById<LinearLayout>(R.id.properties_file_count).property_value as TextView).text =
                        fileCount.toString()
                }
            }
        ...
        if (fileDirItem.isDirectory) {
            ...
            if (activity.baseConfig.appId.removeSuffix(".debug") == "com.simplemobiletools.filemanager.pro") {
                ...
                ensureBackgroundThread {
                    ...
                    activity.runOnUiThread {
                        (view.findViewById<LinearLayout>(R.id.properties_md5).property_value as TextView).text =
                            md5
                    }
                }
            }
